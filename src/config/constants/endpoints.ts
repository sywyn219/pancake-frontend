...
export const INFO_CLIENT = 'https://nftmint.info/subgraphs/name/pancakeswap/exchange'
// export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/pancakeswap/blocks'
export const BLOCKS_CLIENT = 'https://nftmint.info/subgraphs/name/pancakeswap/blocks'
