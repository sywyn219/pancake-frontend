...
export const INFO_CLIENT = 'https://goswap.top/subgraphs/name/pancakeswap/exchange'
// export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/pancakeswap/blocks'
export const BLOCKS_CLIENT = 'https://goswap.top/subgraphs/name/pancakeswap/blocks'
