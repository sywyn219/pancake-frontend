...
export const INFO_CLIENT = 'http://localhost/subgraphs/name/pancakeswap/exchange'
// export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/pancakeswap/blocks'
export const BLOCKS_CLIENT = 'http://localhost:8000/subgraphs/name/pancakeswap/blocks'
