...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://NFT.top/images/tokens/${token.address[2398]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://NFT.top/images/tokens/${token.address[2398]}.svg`;
        const secondarySrc = `https://NFT.top/images/tokens/${tokens[randomTokenIndex].address[2398]}.svg`;
